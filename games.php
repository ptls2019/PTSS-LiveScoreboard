...
<body>
		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-end justify-content-center">
				<div class="col-md-9 ftco-animate pb-5 text-center">
					...
					<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Live Scoreboard <i class="ion-ios-arrow-forward"></i></span></p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="ftco-section ftco-game-schedule bg-light">
		<div class="container">
			<div class="row">
				<div class="col-md-12 heading-section ftco-animate mb-4">
					<span class="subheading">Game Team Netball</span>
				</div>
			</div>
			<div class="row ftco-animate">
				<div class="col-md-12 carousel-game-schedule owl-carousel">
					<div class="item">
						<div class="game-schedule">
							<div class="sport-team d-flex align-items-center">
								<div class="img logo" style="background-image: url(images/jtmk.jpg);"></div>
								<div class="pl-4 desc">
									<span class="venue">Netball Court</span>
									<h4 class="team-name">JTMK</h4>
									<span class="date">October 10, 2019</span>
								</div>
							</div>
						...
						<div class="game-schedule">
							<div class="sport-team d-flex align-items-center">
								...
								<div class="pl-4 desc">
									<span class="venue">Netball Court</span>
									<h4 class="team-name">JP</h4>
									<span class="date">October 10, 20193</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-md-7">
					<div class="heading-section ftco-animate">
						<h2 class="mb-4">Live scoreboard Game Football
							...
							<div class="heading-section ftco-animate">
								<h2 class="mb-4">Live scoreboard Game Netball</h2>
							</div>
							<?php
							$sql = "SELECT game_id FROM team WHERE team_1='JTMK' AND sport='netball'";
							$sql2 = "SELECT * FROM game_score WHERE game_id IN ($sql)";
							$row = $conn->query($sql2)->fetch_object();
							$sql = "SELECT time_game FROM team WHERE team_1='JTMK' AND sport='netball'";
            				$rowt = $conn->query($sql)->fetch_object();
							?>
							<div class="scoreboard mb-5 mb-lg-3">
								<div class="divider text-center"><span>Sukan Jabatan<br><?php echo $rowt->time_game; ?></span></div>
							...
							<?php
							$sql = "SELECT game_id FROM team WHERE team_1='JRKV' AND sport='netball'";
							$sql2 = "SELECT * FROM game_score WHERE game_id IN ($sql)";
							$row = $conn->query($sql2)->fetch_object();
							$sql = "SELECT time_game FROM team WHERE team_1='JRKV' AND sport='netball'";
            				$rowt = $conn->query($sql)->fetch_object();
							?>
							<div class="scoreboard mb-5 mb-lg-3">
								<div class="divider text-center"><span>Sukan Jabatan<br><?php echo $rowt->time_game; ?></span></div>
							...
							<?php
							$sql = "SELECT game_id FROM team WHERE team_1='JKE' AND sport='netball'";
							$sql2 = "SELECT * FROM game_score WHERE game_id IN ($sql)";
							$row = $conn->query($sql2)->fetch_object();
							$sql = "SELECT time_game FROM team WHERE team_1='JKE' AND sport='netball'";
            				$rowt = $conn->query($sql)->fetch_object();
							?>
							<div class="scoreboard mb-5 mb-lg-3">
								<div class="divider text-center"><span>Sukan Jabatan<br><?php echo $rowt->time_game; ?></span></div>
								<div class="d-sm-flex mb-4">
									...
									<div class="sport-team d-flex align-items-center">
										<div class="img logo order-sm-last" style="background-image: url(images/jpa.jpg);"></div>
										<div class="text-center px-1 px-md-3 desc">
											<h3 class="score win"><span><?php echo $row->steam_2set1 + $row->steam_2set2; ?></span></h3>
											<h4 class="team-name">JPA</h4>
										</div>
							...
							<?php
							$sql = "SELECT game_id FROM team WHERE team_1='JPH' AND sport='netball'";
							$sql2 = "SELECT * FROM game_score WHERE game_id IN ($sql)";
							$row = $conn->query($sql2)->fetch_object();
							$sql = "SELECT time_game FROM team WHERE team_1='JPH' AND sport='netball'";
            				$rowt = $conn->query($sql)->fetch_object();
							?>
							<div class="scoreboard mb-5 mb-lg-3">
								<div class="divider text-center"><span>Sukan Jabatan<br><?php echo $rowt->time_game; ?></span></div>
