                ...
                <td>
                  <?php
                    if ($rowselesai->selesai_set1 == 'belum') {
                      ?>
                    <button type="button" onclick="window.location='pointcontrolfoot.php?game_id=<?php echo $row->game_id; ?>'">
                      Set1
                    </button>
                  <?php
                    } else {
                  ...
                  <?php
                    ...
                    if ($rowselesai->selesai_set2 == 'belum') {
                      ?>
                    <button type="button" onclick="window.location='pointcontrolfoot2.php?game_id=<?php echo $row->game_id; ?>'">
                      Set2
                    </button>
                  <?php
                    } else {
