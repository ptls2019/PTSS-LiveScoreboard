						...
						<div class="d-sm-flex mb-4">
							<div class="sport-team d-flex align-items-center">
								...
								<div class="text-center px-1 px-md-3 desc">
									<h3 class="score win" style="font-size:100pt;"><span><?php echo $row->steam_1set1 + $row->steam_1set2; ?></span></h3>
									<h4 class="team-name" style="font-size:100pt;">JTMK</h4>
								</div>
							</div>
							<div class="sport-team d-flex align-items-center">
								<div class="img logo order-sm-last" style="background-image: url(images/jp.jpg);"></div>
								<div class="text-center px-1 px-md-3 desc">
									<h3 class="score lost" style="font-size:100pt;"><span><?php echo $row->steam_2set1 + $row->steam_2set2; ?></span></h3>
									<h4 class="team-name" style="font-size:100pt;">JP</h4>
								</div>
							</div>
						</div>
					</div>
