              ...
              #echo $conn->error; echo $rowselesai->num-rows;
               ?>
                <tr>
                    ...
                    ?>
                    <button type="button" onclick="window.location='pointcontrolnetp2.php?game_id=<?php echo $row->game_id; ?>'">
                      Set1
                    </button>
                    <?php
                    }else{
                    ...
                    if($rowselesai->selesai_set2=='belum'){
                      ?>
                      <button type="button" onclick="window.location='pointcontrolnet2p2.php?game_id=<?php echo $row->game_id; ?>'">
                        Set2
                      </button>
                      <?php
                      }else{
