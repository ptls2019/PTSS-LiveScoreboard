      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="scoreboard mb-5 mb-lg-0">
            <div class="divider text-center"><span>Wed, Oct 10, 2019; Sukan Jabatan<br><?php echo $rowt->time_game; ?></span></div>
        ...
        <section class="w3-row-padding w3-center w3-light-grey">
          <article class="w3-third">
            <p><b></b></p>
            <img src="images/imejindex1.jpg" alt="" width="600" height="400">
            <p></p>
            <p></p>
          </article>
      </div>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p>
            ...
            <script></script> <i></i> <a href="https://colorlib.com" target="_blank"></a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
          </p>
        </div>
      </div>
